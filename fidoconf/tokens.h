...
enum
{
    ID_VERSION = 0, ID_NAME, ID_LOCATION, ID_SYSOP, ID_ADDRESS, ID_INBOUND, ID_PROTINBOUND,
    ID_LISTINBOUND, ID_LOCALINBOUND, ID_TEMPINBOUND, ID_OUTBOUND, ID_TICOUTBOUND, ID_PUBLIC,
    ID_LOGFILEDIR, ID_DUPEHISTORYDIR, ID_NODELISTDIR, ID_FILEAREABASEDIR, ID_PASSFILEAREADIR,
    ID_BUSYFILEDIR, ID_MSGBASEDIR, ID_LINKMSGBASEDIR, ID_MAGIC, ID_SEMADIR, ID_BADFILESDIR,
    ID_NETAREA, ID_NETMAILAREA, ID_DUPEAREA, ID_BADAREA, ID_ECHOAREA, ID_FILEAREA, ID_BBSAREA,
    ID_LOCALAREA, ID_REMAP, ID_LINK, ID_PASSWORD, ID_AKA, ID_OURAKA, ID_AUTOCREATE,
    ID_FORWARDREQUESTS, ID_DENYFWDREQACCESS, ID_FORWARDPKTS, ID_ALLOWEMPTYPKTPWD, ID_PACKNETMAIL,
    ID_ALLOWPKTADDRDIFFER, ID_AUTOCREATEDEFAULTS, ID_AREAFIX, ID_FILEFIX, ID_PAUSE, ID_NOTIC,
    ID_DELNOTRECEIVEDTIC, ID_ADVANCEDAREAFIX, ID_AUTOPAUSE, ID_FWDPRIORITY,
    ID_DENYUNCONDFWDREQACCESS, ID_EXPORT, ID_IMPORT, ID_MANDATORY, ID_MANUAL, ID_OPTGRP,
    ID_FWDMASK, ID_FWDDENYMASK, ID_LEVEL, ID_ECHOLIMIT, ID_ARCMAILSIZE, ID_PKTSIZE,
    ID_MAXUNPACKEDNETMAIL, ID_PKTPWD, ID_TICPWD, ID_AREAFIXPWD, ID_FILEFIXPWD, ID_BBSPWD,
    ID_SESSIONPWD, ID_HANDLE, ID_EMAIL, ID_EMAILFROM, ID_EMAILSUBJ, ID_EMAILENCODING,
    ID_ECHOMAILFLAVOUR, ID_FILEECHOFLAVOUR, ID_ROBOT, ID_ROUTE, ID_ROUTEMAIL, ID_ROUTEFILE,
    ID_PACK, ID_UNPACK, ID_PACKER, ID_INTAB, ID_OUTTAB, ID_HELPFILE, ID_FWDFILE, ID_FWDDENYFILE,
    ID_AUTOCREATEFILE, ID_AUTOCREATEFLAG, ID_LINKBUNDLENAMESTYLE, ID_ECHOTOSSLOG, ID_IMPORTLOG,
    ID_STATLOG, ID_LINKWITHIMPORTLOG, ID_KLUDGEAREANETMAIL, ID_FILEAREASLOG, ID_FILENEWAREASLOG,
    ID_LONGNAMELIST, ID_FILEARCLIST, ID_FILEPASSLIST, ID_FILEDUPELIST, ID_LOGLEVELS,
    ID_SCREENLOGLEVELS, ID_ACCESSGRP, ID_LINKGRP, ID_CARBONTO, ID_CARBONFROM, ID_CARBONADDR,
    ID_CARBONKLUDGE, ID_CARBONSUBJ, ID_CARBONTEXT, ID_CARBONCOPY, ID_CARBONMOVE, ID_CARBONEXTERN,
    ID_NETMAILEXTERN, ID_CARBONDELETE, ID_CARBONREASON, ID_EXCLUDEPASSTHROUGHCARBON, ID_LOCKFILE,
    ID_TEMPOUTBOUND, ID_AREAFIXFROMPKT, ID_REPORTSATTR, ID_KILLREQUESTS, ID_CREATEDIRS,
    ID_LONGDIRNAMES, ID_SPLITDIRS, ID_ADDDLC, ID_FILESINGLEDESCLINE, ID_FILECHECKDEST,
    ID_PUBLICGROUP, ID_LOGECHOTOSCREEN, ID_SEPARATEBUNDLES, ID_CARBONANDQUIT, ID_CARBONKEEPSB,
    ID_CARBONOUT, ID_IGNORECAPWORD, ID_NOPROCESSBUNDLES, ID_REPORTTO, ID_EXECONFILE,
    ID_DEFARCMAILSIZE, ID_MSGSIZE, ID_AFTERUNPACK, ID_BEFOREPACK, ID_PROCESSPKT, ID_SPLITSTR,
    ID_ROBOTORIGIN, ID_ROBOTSAREA, ID_FILEDESCPOS, ID_DLCDIGITS, ID_FILEMAXDUPEAGE,
    ID_FILEFILEUMASK, ID_FILEDIRUMASK, ID_ORIGININANNOUNCE, ID_MAXTICLINELENGTH, ID_FILELOCALPWD,
    ID_FILELDESCSTRING, ID_SAVETIC, ID_AREASMAXDUPEAGE, ID_DUPEBASETYPE, ID_FIDOUSERLIST,
    ID_NODELIST, ID_DIFFUPDATE, ID_DELAPPLIEDDIFF, ID_FULLUPDATE, ID_DEFAULTZONE,
    ID_NODELISTFORMAT, ID_LOGOWNER, ID_LOGPERM, ID_LINKDEFAULTS, ID_CREATEAREASCASE,
    ID_AREASFILENAMECASE, ID_CONVERTLONGNAMES, ID_CONVERTSHORTNAMES, ID_DISABLEKLUDGERESCANNED,
    ID_DISABLEPID, ID_DISABLETID, ID_TOSSINGEXT, ID_SETCONSOLETITLE, ID_ADDTOSEEN, ID_IGNORESEEN,
    ID_TEARLINE, ID_ORIGIN, ID_BUNDLENAMESTYLE, ID_KEEPTRSMAIL, ID_KEEPTRSFILES, ID_FILELIST,
    ID_CREATEFWDNONPASS, ID_AUTOPASSIVE, ID_NETMAILFLAG, ID_MINDISKFREESPACE, ID_ECHOAREADEFAULT,
    ID_FILEAREADEFAULT, ID_CARBONRULE, ID_CARBONFROMAREA, ID_CARBONGROUPS,
    ID_AUTOAREACREATESUBDIRS, ID_AUTOFILECREATESUBDIRS, ID_ADVISORYLOCK, ID_NAMES, ID_REQIDXDIR,
    ID_SYSLOG_FACILITY, ID_FILEFIXFSC87SUBSET, ID_FILEBOX, ID_FILEBOXALWAYS, ID_FILEBOXESDIR,
    ID_CARBONEXCLUDEFWDFROM, ID_HPTPERLFILE, ID_READONLY, ID_WRITEONLY, ID_QUERYREPORTS,
    ID_NOTVALIDFILENAMECHARS, ID_ARCNETMAIL, ID_RULESDIR, ID_NORULES, ID_QUEUEFILE,
    ID_FILEDESCNAME, ID_FILEDESCRIPTION, ID_FORWARDREQUESTTIMEOUT, ID_IDLEPASSTHRUTIMEOUT,
    ID_KILLEDREQUESTTIMEOUT, ID_PACKNETMAILONSCAN, ID_UUEECHOGROUP, ID_TICKERPACKTOBOX,
    ID_LINKFILEBASEDIR, ID_SENDMAILCMD, ID_TEMPDIR, ID_ANNOUNCESPOOL, ID_ANNAREATAG, ID_ANNINCLUDE,
    ID_ANNEXCLUDE, ID_ANNTO, ID_ANNFROM, ID_ANNSUBJ, ID_ANNADDRTO, ID_ANNADDRFROM, ID_ANNORIGIN,
    ID_ANNMESSFLAGS, ID_ANNFILEORIGIN, ID_ANNFILERFROM, ID_FILEAREACREATEPERMS,
    ID_NEWAREAREFUSEFILE, ID_REDUCEDSEENBY, ID_FROMNAME, ID_SEQDIR, ID_SEQOUTRUN, ID_AVAILLIST,
    ID_ADVSTATISTICSFILE, ID_PACKAKA, ID_AREAGROUP, ID_AREAGROUPDEFAULTS, ID_GRPDESC, ID_LISTECHO,
    ...
    ID_AUTOSUBSCRIBE, ID_BADINBOUND
};
