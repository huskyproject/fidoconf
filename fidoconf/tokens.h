...
enum {
    ...
    ID_TEMPOUTBOUND,
    ID_AREAFIXFROMPKT,
    ID_AREAFIXREPORTSATTR,
    ID_AREAFIXKILLREQUESTS,
    ID_FILEFIXREPORTSATTR,
...
token_t parseline_tokens[] =
{
    ...
    { "autofilecreateflag", ID_AUTOFILECREATEFLAG },
    ...
    { "filefixnames", ID_FILEFIXNAMES },
    { "filefixpwd", ID_FILEFIXPWD },
    { "filefixreportsattr", ID_FILEFIXREPORTSATTR },
